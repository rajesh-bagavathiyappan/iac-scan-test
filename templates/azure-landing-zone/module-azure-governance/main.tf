resource "azurerm_management_group_policy_assignment" "monitoring_governance" {
...
resource "azurerm_management_group_policy_assignment" "iam_governance" {
  name                 = "iam_governance"
  scope                = data.azurerm_subscription.current.id
...
resource "azurerm_management_group_policy_assignment" "security_governance" {
...
resource "azurerm_management_group_policy_assignment" "data_protection_governance" {
