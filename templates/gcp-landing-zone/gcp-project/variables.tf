...
variable "project_iam_binding" {
  description = "IAM users permissions handler on Project level"
...
variable "shared_vpc" {
  description = "Shared VPC enabling condition"
  type        = bool
  default     = false
}
...
variable "cloud_nat" {
  type        = map(object({
    region                   = string
    router_name              = string
    ip_count                 = list(string)
  }))
  description = "Cloudnat configuration"
  default = {}
}
...
//variable "org_bucket" {
//  type        = string
//  description = "gcp org tfstate bucket"
//}
//
//variable "org_prefix" {
//  type = string
//  description = "gcp org tfstate prefix"
//}

variable "shared_vpc_project_id" {
  type        = string
  description = "ID of GCP project which is shared vpc - shared vpc host project ID"
  default     = ""
}

variable "shared_vpc_network_name" {
  type        = string
  description = "Network name of GCP project which is shared vpc - shared vpc host project network name"
  default     = ""
}
...
variable "pgsql" {
  type = map(object({
    ...
    random_instance_name            = optional(bool)
  ...
  description = "Postgres SQL configuration"
}
